...
from dataset.bdd100k5 import BDD100K5Dataset
...
model = SPPNet(output_channels=10, enc_type='mobilenetv2', dec_type='maspp').to(device)
model_path = '../model/bdd100k_deeplabv3p_mobilenetv2_total/model_tmp.pth'
