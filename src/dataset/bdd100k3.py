...
if __name__ == '__main__':
    ...
    dataset = BDD100K3Dataset(split='train', net_type='deeplab', ignore_index=4, debug=True,affine_augmenter=affine_augmenter, image_augmenter=image_augmenter, target_size=(1280, 1280))
    dataloader = DataLoader(dataset, batch_size=8, shuffle=True)
    palette = np.array([[0, 0, 0],      # black
                        [255, 0, 0],    # red
                        [0, 0, 255],    # blue
                        [255, 0, 255],  # pink
                        [0, 255, 0],    # green for light 
                        [255, 255, 255],# white for car 
                        [0, 64, 64] ])  # cyan for person 
